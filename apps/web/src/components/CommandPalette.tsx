...
import { filterCommands, type CommandItem } from '@recoverflow/core';
import type { ExecutedItem, DashboardTab } from '@recoverflow/core';
...
const ACTION_COMMANDS: CommandItem[] = [
  ...
  { id: 'act-reset-demo', label: 'Reset Demo State (Defaults)', keywords: ['reset', 'demo', 'state', 'defaults', 'restore', 'restart'], category: 'action' },
];
