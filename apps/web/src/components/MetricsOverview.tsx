    ...
    <div className="space-y-4" aria-live="polite">
      ...
      {recomputeFeedback && (
        <div
          role="status"
          aria-live="polite"
          className="bg-indigo-50 border border-indigo-200 text-indigo-800 text-xs px-3 py-1.5 rounded-lg flex items-center gap-2 animate-fade-in"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span
              data-testid="net-recovery-metric"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3.5 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-semibold text-slate-700">Customer Contacts</span>
            <div className="text-lg font-bold text-slate-900">
              {kpis.customerContactCount} <span className="text-xs font-medium text-slate-600">attempted</span>
            </div>
            <span className="text-[11px] text-slate-600">Zero non-budgeted contacts</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3.5 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-semibold text-slate-700">Unnecessary Retry Rate</span>
            <div className="text-lg font-bold text-slate-900">
              {kpis.unnecessaryRetryRate}%
            </div>
            <span className="text-[11px] text-slate-600">Budgeted items failing attempt</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3.5 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-semibold text-slate-700">Avg Attempts to Recover</span>
            <div className="text-lg font-bold text-slate-900">
              {kpis.avgAttemptsBeforeRecovery} <span className="text-xs font-medium text-slate-600">attempts</span>
            </div>
            <span className="text-[11px] text-slate-600">Hard capped at 3 attempts</span>
          </div>
        </div>
