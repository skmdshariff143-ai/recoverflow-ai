...
| **Idempotency Replay Attacks** | Duplicate retries or double payment link creation | Server-side in-memory SHA-256 idempotency cache with TTL and conflict detection. |
