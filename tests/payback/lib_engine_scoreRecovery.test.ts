...
import { calculateExpectedValuePaise, probabilityToBps } from '@recoverflow/core';
import type { FailedPayment, FailureCategory } from '@recoverflow/core';
...
describe('scorePayment', () => {
  ...
  it('scores all 100 fixture records without crashes, all outputs well-formed', () => {
    const fixturePath = resolve(process.cwd(), 'data/synthetic-payments.json');
