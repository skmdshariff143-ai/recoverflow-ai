...
export const AdapterEvidenceClassSchema = z.enum([
  'SYNTHETIC',
  'LIVE_TEST_MODE',
  'FALLBACK',
  'UNVERIFIED',
...
export type AdapterEvidenceClass = z.infer<typeof AdapterEvidenceClassSchema>;
...
export const RecoveryExecutionResultSchema = z.object({
  ...
  evidenceClass: AdapterEvidenceClassSchema.default('SYNTHETIC'),
